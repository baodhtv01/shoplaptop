    ...
    public function print_order_convert($checkout_code){
        ...
        <div style="float: left; margin: 0 0 1.5em 0; ">
         <strong style="font-size: 18px;">PhongVu</strong>
          <br />
          <strong>Địa chỉ:</strong> 1 Đoàn kết - Hồ Chí Minh
          <br/>
          <strong>Điện thoại:</strong> 091xxxxxxx
          <br/>
          <strong>Website:</strong> http://localhost:8000/
          <br/>
          <strong>Email:</strong> phuocthien@gmail.com
        </div>
